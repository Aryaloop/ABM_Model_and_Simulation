...
clear-all
  ...
  set minimumWage NilaiUpahMinimum

  set UI TunjanganPengangguran
  set productivity 2
  set priceofgoods 10

  create-firms JumlahPerusahaan [
...
;;;;;;;;;;;;;;;;;;;;;;;;
to job-destruction
  let %d Pemecatan ; where 10% is the job destruction rate
  let n count jobs
...
907
190
Penawaran upah tertinggi yang dibuat oleh perusahaan
...
787
235
Jumlah Perusahaan dalam simulasi
count firms
17
1
11
...
842
145
Penawaran upah terendah oleh perusahaan
...
1017
100
Durasi maksimum seseorang menganggur
...
362
410
Standar deviasi durasi pengangguran di antara tenaga kerja
...
357
455
Durasi pengangguran rata-rata untuk seluruh tenaga kerja
...
<experiments>
  ...
  <experiment name="VaryingMinWage (1)" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean [currentwage] of workers with [employed? = TRUE]</metric>
    <metric>min [maxValue] of firms</metric>
  ...
  <experiment name="VaryingMinWage (2)" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean [currentwage] of workers with [employed? = TRUE]</metric>
    <metric>min [maxValue] of firms</metric>
